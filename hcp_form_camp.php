		...
		<div class="section mt-7">
            <div class="card">
             ...
             <!--   <div class="wide-block pt-2 pb-2">
							...
							<div class="row">
								<div class="col-3">
									<b>Permanent Account Number (PAN) Card	</b>
								</div>
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Documents evidencing HCP’s educational qualification such as degree certificate, certificate of passing or such other equivalent document</b>
								</div>
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Registration Certificate with Medical Council</b>
								</div>
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="service_agreement_camp.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
