            ...
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    <div class="col-6 text-center">
                        <b>Information Request Form</b><br><br><br>
						<div class="text-center lh" ><i>Draft for Discussion purpose only</i></div>
                    </div>
                    <div class="col-6">
                        <div class="logo-div"><span style="font-size: 20px;font-weight: bold;">Micro Labs to add logo</span></div>
						<div class="text-center lh" >Private and Confidential</div>
                    </div>
                </div>

            </div>
        </div>
            <p class="text-center">This form should be used to gather details from HCPs prior to engaging them for professional services.</p>
            <br>
                <div class="wide-block pt-2 pb-2">
							...
							<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper">
										<input type="text" class="form-control" id="" placeholder="Dr. Ria Dessai" required="">
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper">
										<input type="text" class="form-control" id="details_activity" placeholder="45/47, Dhanjit St, Mumbadevi Area, Kalbadevi, Mumbai, Maharastra 400003" required="">
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper">
										<input type="text" class="form-control" id="details_activity" placeholder="MBBS" required="">
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper"><input type="date" class="form-control" id="" required=""></div>
								</div>
							...
							<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper"><input type="number" class="form-control" id="" required=""></div>
								</div>
	...
	<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    <div class="col-6 text-center">
                        <b>Information Request Form</b><br><br><br>
						<div class="text-center lh" ><i>Draft for Discussion purpose only</i><br><br>
						HCP Sign  & Stamp: __________________<br><br>
						Micro labs Employee Sign: __________________</div>
                    </div>
                    <div class="col-6">
                        <div class="logo-div"><span style="font-size: 20px;font-weight: bold;">Micro Labs to add logo</span></div>
						<div class="text-center lh" >Private and Confidential<br><br>
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="hcp_agreement_pma.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
