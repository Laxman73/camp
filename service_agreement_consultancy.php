...
<body>
    ...
    <div class="appHeader bg-primary">
        ...
        <div class="pageTitle">CAMP SERVICE AGREEMENT</div>
        <div class="right"></div>
    </div>
            ...
            <div class="card">
                ...
                <div class="wide-block pt-2 pb-2">
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Effective Date<span style="color:#ff0000">*</span></b>
								</div>
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Doctor Name<span style="color:#ff0000">*</span></b>
								</div>
								
								<div class="col-9">
									<div class="input-wrapper">
										<input type="text" class="form-control" id="details_activity" placeholder="" required>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Title of the Camp<span style="color:#ff0000">*</span></b>
								</div>
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Date<span style="color:#ff0000">*</span></b>
								</div>
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Amount<span style="color:#ff0000">*</span></b>
								</div>
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Amount in words<span style="color:#ff0000">*</span></b>
								</div>
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Termination Date<span style="color:#ff0000">*</span></b>
								</div>
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="delivery_service_form_consultancy.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
