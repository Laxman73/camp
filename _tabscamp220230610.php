...
if ($display_all == 1) {
	$naf_form_q_url = "index_naf_qtr.php?rid=$rid&prid=$prid&userid=$USER_ID&pid=$pid&category=$category&display_all=1";
	$naf_form_camp_url = "index_naf_camp.php?rid=$rid&prid=$prid&userid=$USER_ID&pid=$pid&category=$category&display_all=1";
	$naf_request_letter_url = "request_letter_camp.php?rid=$rid&prid=$prid&userid=$USER_ID&pid=$pid&category=$category&display_all=1";
	...
	$delivery_form_url = "delivery_service_form_camp.php?rid=$rid&prid=$prid&userid=$USER_ID&category=$category&display_all=1";
	$delivery_form_ho_url = "mt_delivery_service_form_camp.php?rid=$rid&prid=$prid&userid=$USER_ID&category=$category&display_all=1";
