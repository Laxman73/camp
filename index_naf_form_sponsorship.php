...
<body>
    ...
    <div class="appHeader bg-primary">
        ...
        <div class="pageTitle camp">NAF (Activity Basis) HO</div>
        <div class="right"></div>
    </div>
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="naf_form_sponsorship.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
