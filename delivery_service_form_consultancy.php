            ...
            <div class="card">
                ...
                <div class="wide-block pt-2 pb-2">
							...
							<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper">
										<select class="form-control custom-select" id="myselection2" >
											<option selected="" value="">Choose...</option>
					...
					<div id="showoption1" class="myDiv2">
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="ho_delivery_service_form_consultancy.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
