...
$_q1="select contactmaster.firstname,contactmaster.lastname,contactmaster.qualification,contactmaster.mobile,contactmaster.registration_no,contactmaster.otherstate,contactmaster.othercity from contactmaster where contactmaster.id='$Doctor_id'";
$_r1=sql_query($_q1,"");
...
$sql_mobilenum = "SELECT crm_naf_hcp_details.mobile FROM crm_request_main 
inner join crm_request_details on crm_request_details.crm_request_main_id=crm_request_main.id 
INNER JOIN crm_naf_main ON crm_request_main.naf_no = crm_naf_main.naf_no
INNER JOIN crm_naf_hcp_details ON crm_naf_main.id = crm_naf_hcp_details.naf_main_id
where crm_request_main.id='".$pid."' and crm_request_main.deleted=0 and crm_request_details.deleted=0 AND crm_naf_main.deleted=0 AND crm_naf_hcp_details.deleted = 0 AND crm_request_details.hcp_id = crm_naf_hcp_details.hcp_id";
$check_mobilenum=GetXFromYID($sql_mobilenum);

$sql_hcp_pan = "SELECT crm_naf_hcp_details.hcp_pan FROM crm_request_main 
inner join crm_request_details on crm_request_details.crm_request_main_id=crm_request_main.id 
INNER JOIN crm_naf_main ON crm_request_main.naf_no = crm_naf_main.naf_no
INNER JOIN crm_naf_hcp_details ON crm_naf_main.id = crm_naf_hcp_details.naf_main_id
where crm_request_main.id='".$pid."' and crm_request_main.deleted=0 and crm_request_details.deleted=0 AND crm_naf_main.deleted=0 AND crm_naf_hcp_details.deleted = 0 AND crm_request_details.hcp_id = crm_naf_hcp_details.hcp_id";
$hcp_pan=GetXFromYID($sql_hcp_pan);


$data_hcp = GetDataFromID('crm_naf_hcp_details', 'naf_main_id', $rid);

$hcp_address=GetXFromYID("select hcp_address FROM crm_naf_hcp_details WHERE deleted = 0 AND naf_main_id = '".$rid."' AND hcp_id='".$Doctor_id."'");
$hcp_pan=GetXFromYID("select hcp_pan FROM crm_naf_hcp_details WHERE deleted = 0 AND naf_main_id = '".$rid."' AND hcp_id='".$Doctor_id."'");
$check_mobilenum=GetXFromYID("select mobile FROM crm_naf_hcp_details WHERE deleted = 0 AND naf_main_id = '".$rid."' AND hcp_id='".$Doctor_id."'");
$Honorium=GetXFromYID("select honorarium_amount FROM crm_naf_hcp_details WHERE deleted = 0 AND naf_main_id = '".$rid."' AND hcp_id='".$Doctor_id."'");
$hcp_role=GetXFromYID("select role_of_hcp FROM crm_naf_hcp_details WHERE deleted = 0 AND naf_main_id = '".$rid."' AND hcp_id='".$Doctor_id."'");
$hcp_qualification=GetXFromYID("select hcp_qualification FROM crm_naf_hcp_details WHERE deleted = 0 AND naf_main_id = '".$rid."' AND hcp_id='".$Doctor_id."'");
...
$e_sign_cheque_date=GetXFromYID("select e_sign_cheque_date from crm_request_main where id=".$pid." and deleted=0 ");
$get_category_no=GetXFromYID("select category_id from crm_request_main where id=".$pid." and deleted=0 ");
...
<body>
    ...
    <div class="appHeader bg-primary">
        ...
        <div class="right">
			<a href="http://88.99.140.102/MicrolabReplicav3/modules/CRM_demo/index_pma.php?userid=<?php echo $USER_ID;?>">
            ...
            <div class="tab-pane fade show active" id="pilled" role="tabpanel">
                ...
                <div class="section full mt-1">
                    ...
                    <div class="wide-block pt-2 pb-2" <?php echo $hidequest;?> <?php echo $hidequest1;?>>
                       ...
                       <div class="p-center"><h2 style="color:red;"><b <?php echo $hide;?>>Note:Would you like to send the HCP Agreement to the doctor as a SMS link?</b></h2></div><br>
                            ...
                            <div class="row mt-3" style="width: 100%;justify-content: center;">
                                ...
                                <div class="col1-3">
                                    <div class="input-wrapper">
                                        <input type="number" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="" required="" value="<?php echo $check_mobilenum;?>" readonly>
                                    </div>
                                </div>
    ...
    <div id="appCapsule">
        ...
        <div>
                ...
                <b> Dr. <?php echo $firstname . ' ' . $lastname; ?> </b>, a registered medical practitioner according to the applicable laws of India and guidelines laid down by the relevant regulatory body, an Indian citizen having his/her address at  <b> <?php echo $hcp_address; ?> </b> bearing PAN <b> <?php echo $hcp_pan; ?> </b> (hereinafter
                ...
                <div class="col-1">
                    ...
                    <div class="col-4">
                        <input type="text" value="<?php echo $topic; ?>" name="topic" class="form-control" id="topic_input" placeholder="" <?php echo $readonly?>>
                    </div>
                </div>
                <br>
                <div class="row">
                <div class="col-1">
                    ...
                    <div class="col-4">
                        <input type="text" value="<?php echo $venue; ?>" name="venue" class="form-control" id="venue_input" placeholder="" <?php echo $readonly?>>
                    </div>
                </div>
                <br>
                <div class="row">
                <div class="col-1">    
                    ...
                    <div class="col-4">
                        <input type="date" value="<?php if($readonly!=''){echo date('Y-m-d', strtotime($meeting_date));} ?>" name="meeting_date" class="form-control" id="meeting_date_input" placeholder="" <?php echo $readonly?>>
                    </div>
                </div>
                </ol>
                <br><br>
                ...
                4.1 This Agreement shall commence on the <?php echo date('d-m-Y', strtotime($e_sign_cheque_date)); ?> and shall continue to be in full force and effect until <b><?php echo date('d-m-Y', strtotime($e_sign_cheque_date. ' + 90 days')); ?></b>, unless earlier terminated by either Party in accordance with the provisions of this Section (<b>‘Term’</b>).
				</div>
                <br><br>
  ...
  <br>
                ...
                <div class="row mlm-150">
                            <div class="col-6">
                                ...
                                <b>DATE: <u><?php echo date('d M Y', strtotime(FormatDate(TODAY,'H')));?></u></b>
                        ...
                        <div class="row mlm-150">
                            <div class="col-6">
                                ...
                                <span>SIGNED AND DELIVERED by the <b> Dr. <?php echo $firstname . ' ' . $lastname; ?> </b>, the within named Party of the Second
                                    Part.<br>
        ...
        <?php if($MODE != 'R'){ ?>
                <div class="section full mt-2">
                    <div class="wide-block pt-2 pb-2">
                        <form action="save_agrrement.php" id="agreement_Form" method="post">
                            <input type="hidden" name="crm_hcp_information_id" value="<?php echo $hcp_information_ID;?>">
                            <input type="hidden" name="rid" id="rid" value="<?php echo $rid;?>">
                            <input type="hidden" name="pid" id="pid" value="<?php echo $pid;?>">
                            <input type="hidden" name="userid" value="<?php echo $USER_ID;?>">
                            <input type="hidden" name="category" value="<?php echo $get_category_no;?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="index_pma.php?userid=<?php echo $USER_ID?>"><button type="button" <?php echo $submithide;?> id="cancelbutton" class="exampleBox btn btn-primary rounded me-1">Cancel</button></a>
                                </div>
                            </div>
                            <?php if($readonly != ''){ ?>
                                <div class="row">
                                <div class="col">
                                    <a href="index_pma.php?userid=<?php echo $USER_ID?>"><button type="button" id="cancelbutton" class="exampleBox btn btn-primary rounded me-1">Cancel</button></a>
                                </div>
                                </div>
                            <?php } ?>
                        </form>
    ...
    <script>
       ...
       document.getElementById("clear_sign1").addEventListener('click', function(){
        ...
        function validate(){
            ...
            var meeting_date= document.getElementById("meeting_date_input").value;
            document.getElementById('meeting_date').value = meeting_date;
