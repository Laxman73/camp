...
<body>
    ...
    <div class="appHeader bg-primary">
        ...
        <div class="pageTitle">PROJECT MARKET ANALYSIS SERVICE AGREEMENT</div>
        <div class="right"></div>
    </div>
    ...
    <div id="appCapsule">
        ...
        <div>
				...
				effective as on the date of last signature of the parties <b>(‘Effective Date’)</b> by and between:
				<br><br>
				...
				<b>AND</b><br><br>
				Dr. _________________, an Indian citizen, a registered medical practitioner according to the
				applicable laws of India and guidelines laid down by the relevant regulatory body and/or a Healthcare
				Professional, residing at ___________________ holding PAN _____________ (hereinafter
				...
				<ol type="a">
					...
					focus on.
					<br><br>
					(Collectively, hereinafter referred to as the <b>‘Purpose’</b>)</li>
					<br>
				</ol>
				...
				Company’s market research titled ‘_______________’, that has been designed and compiled
				...
				above-mentioned research, the Parties have mutually agreed to an amount of INR _______
				(Rupees _________________) as fee. Parties agree that this would constitute full and
				...
				4.1 This Agreement shall commence on the Effective Date and shall continue until <b>31 March 2023</b>
  ...
  <br>
                ...
                <div class="row mlm-150">
                    ...
                    <div class="col-6">
				   			...
				   			<form>
								<div class="custom-file-upload ht-80">
									<label for="fileuploadInput">
										<img src="assets/img/Capture1.PNG" class="w-100">
									</label>
								</div>
							</form>
							<br>
				...
				<div class="row mlm-150">
					...
					<span>SIGNED AND DELIVERED by the <b>HEALTHCARE
                    ...
                    <div class="col-6">
				   			...
				   			<form>
								<div class="custom-file-upload ht-80">
									<label for="fileuploadInput">
										<img src="assets/img/Capture.PNG" class="w-100">
									</label>
								</div>
							</form>
							<br>
