		...
		<div class="card">         
      	...
      	<div class="section mt-2">
			...
			<div class="card-body">
				...
				<div class="form-group basic">
					<div class="input-wrapper">
						<label class="label" for="">rationale for selection:</label>
						<textarea id="" rows="3" class="form-control"></textarea>
					</div>
				</div>
				...
				<div class="form-group basic">
					<div class="input-wrapper">
						<label class="label" for="">In case of an Advisor, please elaborate the role of the Advisor:</label>
						<textarea id="" rows="3" class="form-control"></textarea>
					</div>
				</div>
        ...
        <div class="card-body">
            ...
            <div class="wide-block pt-2 pb-2">
				...
				<div class="row">
								...
								<div class="col-3">
									Compliance Team:: ___________________
								</div>
							</div>
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="hcp_form_advisory.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
