...
if ($rid != '' && $category == '')
	$category = GetXFromYID("select category_id from crm_naf_main where id='$rid' ");
...
if (!empty($rid) && $PROFILE_ID == 11) {
	$MODE = 'R';
}


if ($PROFILE_ID == 6 || $PROFILE_ID == 7 || $PROFILE_ID == 15 || $PROFILE_ID == 27) {
	$MODE = 'R';
}
...
<body>
	...
	<?php include '_tabs_naf_advisory.php'; ?>
	...
	<div id="appCapsule">
		...
		<div class="tab-content mt-7">
			...
			<form action="save_naf_advisory.php" id="naf_form" method="post">
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								...
								<div class="col-9">
									...
									<div class="col-6 input-wrapper">
										<input type="date" class="form-control" min="<?php echo TODAY; ?>" required="" value="<?php echo $startDate; ?>" id="txtSdate" name="txtSdate" <?php echo $readonly; ?>>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-9">
									...
									<div class="col-6 input-wrapper">
										<input type="date" class="form-control" min="<?php echo TODAY; ?>" id="txtTdate" required="" value="<?php echo $naf_end_date; ?>" name="txtTdate" <?php echo $readonly; ?>>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper">
										<input type="text" name="activity_name" value="<?php echo $naf_activity_name; ?>" class="form-control" required="" id="activity_name" placeholder="" <?php echo $readonly; ?>>
									</div>
								</div>
							</div>
						...
						<div class="wide-block pt-2 pb-2">
							...
							<div class="row">
								...
								<div class="col-3">
									<b>Virtual / Physical<span style="color:#ff0000">*</span></b>
								</div>

								<div class="col-9">
									<div class="input-wrapper">
										<select class="form-control custom-select" id="virtual_physical" name="virtual_physical" required <?php echo $selectoption; ?>>
											<?php if ($selectoption == "") { ?>
												<option selected="" value="">Choose...</option>
												<option value="1">Virtual</option>
												<option value="2">Physical</option>
												<?php } else {
												if ($virtual_physical == '1') { ?>
													<option value="1">Virtual</option>
												<?
												}
												if ($virtual_physical == '2') { ?>
													<option value="2">Physical</option>
											<?
												}
											} ?>
		...
		<div class="card">
			<div class="card-body">
				...
				<div class="form-group basic">
					<div class="input-wrapper">
						<label class="label" for="">Objective/Rationale<span style="color:#ff0000">*</span></label>
		...
		<div class="card">
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-3">
						<b>Budgeted Activity Cost Details<span style="color:#ff0000">*</span></b><!--<br>Kindly complete all the relevant cost elements to be incurred):<span style="color:#ff0000">*</span>-->
					</div>
				...
				while ($row = sql_fetch_assoc($_r)) {
					//DFA($row);
					$compulsory = ($row['typeid'] == '6') ? 'required="" ' : '';
					$compulsoryfield = ($row['typeid'] == '6') ? '<span style="color:#ff0000">*</span>' : '';
	...
	<div class="section mt-2">
		<div class="card">
			<div class="card-body">
				...
				<div class="form-group basic">
					<div class="input-wrapper">
						<label class="label" for="">In case of an Advisor, please elaborate the role of the Advisor:<span style="color:#ff0000">*</span></label>
						<textarea id="role_of_Advisor" name="role_of_Advisor" required="" rows="3" class="form-control" <?php echo $readonly; ?>><?php echo $role_of_advisory; ?></textarea>
					</div>
				</div>
	...
	<script>
		...
		$('#naf_form').submit(function() {
			var ret_val = false;
			var naf_from_date = document.getElementById("txtSdate").value;
			var naf_to_date = document.getElementById("txtTdate").value;
			var from_date = new Date(naf_from_date);
			var to_date = new Date(naf_to_date);
			var x = document.getElementById("Product").value;
			var others = document.getElementById("others").value
			var honorarium_amt = document.getElementById("crm_14").value
