...
if ($display_all == 1) {
	$naf_form_q_url = "index_camp.php?rid=$rid&prid=$prid&userid=$USER_ID&pid=$pid";
	$naf_form_camp_url = "naf_camp.php?rid=$rid&prid=$prid&userid=$USER_ID&pid=$pid";
...
//Medical Head
if($PROFILE_ID == 11){
	$user_tabs = array(1,2,3,4,5,6,7,8,9);
}
