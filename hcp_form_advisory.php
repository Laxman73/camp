            ...
            <div class="card">
                ...
                <div class="wide-block pt-2 pb-2">
							...
							<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper"><input type="text" class="form-control" id="" required onkeydown="return /[a-z]/i.test(event.key)"></div>
								</div>
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="service_agreement_advisory.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
