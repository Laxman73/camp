    ...
    <div id="appCapsule">
  	...
  	<div class="wide-block pt-2 pb-2">
							...
							<!--<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper">
										<input type="text" class="form-control" id="event_id" placeholder="" required="">
									</div>
								</div>
							</div>-->
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="service_form_pma.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
