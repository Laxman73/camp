...
<body>
    ...
    <div class="appHeader bg-primary">
        ...
        <div class="pageTitle camp">NAF (Activity Basis) Field</div>
        <div class="right"></div>
    </div>
			...
			<table id="example" class="display mt-2" style="width:100%">
				...
				<thead>
					...
					<tr >
						<th></th>
						<th>Sr. No</th>
						<th>Name of the HCO/Approved Institution/Others</th>
						<th>Amount</th>
						<th>Address</th>
						<th>PAN #</th>
						<th>Type of Event</th>
        ...
        <div class="card-body">
            ...
            <div class="wide-block pt-2 pb-2">
				...
				<div class="row">
								...
								<div class="col-2">
									State Head: ___________________
								</div>
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="sponsorship.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
