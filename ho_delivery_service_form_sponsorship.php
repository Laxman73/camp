...
<body>
    ...
    <div class="appHeader bg-primary">
        ...
        <div class="pageTitle">DELIVERY OF SERVICE FORM HO</div>
        <div class="right"></div>
    </div>
                ...
                <div class="wide-block pt-2 pb-2">
						...
						<div class="wide-block pt-2 pb-2">
							...
							<div class="row">
								...
								<div class="col-9">
									<div class="input-wrapper"><input type="number" class="form-control" id="" ></div>
								</div>
							</div>
	   		...
	   		<table id="example" class="display mt-2" style="width:100%">
				...
				<thead>
					...
					<tr >
						<th></th>
						<th>Sr. No</th>
						<th>Name of the HCO/Approved Institution</th>
						<th>Amount</th>
						<th>Address</th>
						<th>PAN #</th>
						<th>Type of Event</th>
						<th>Platform of the event</th>
						<th>Name and Number of sessions</th>
					</tr>
				</thead>
				<tbody>
                    <tr>
		...
		<div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a href="delivery_service_form_sponsorship.php"><button type="button" class="exampleBox btn btn-primary rounded me-1">Submit</button></a>
                    </div>
                    <div class="col">
